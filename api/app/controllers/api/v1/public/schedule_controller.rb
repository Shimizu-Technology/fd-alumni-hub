    ...
    module Public
      class ScheduleController < BaseController
        def index
          ...
          games = tournament.games.includes(:division_record, { home_team: [ :division_record, :team_class_memberships, :class_cohorts ] }, { away_team: [ :division_record, :team_class_memberships, :class_cohorts ] }).ordered.to_a
          teams = tournament.teams.includes(:division_record, :team_class_memberships, :class_cohorts).order(:display_name, :id).to_a
